            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-slate-800 p-5 rounded-xl border border-slate-700 h-full flex flex-col justify-center">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer bg-slate-900 p-4 rounded-lg border border-transparent hover:border-amber-500/50">
                    <input type="checkbox" checked={showQuestionOnDevice} onChange={(e) => setShowQuestionOnDevice(e.target.checked)} className="w-5 h-5 accent-amber-500 cursor-pointer shrink-0 mt-0.5" />
